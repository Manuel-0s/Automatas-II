// Generated from c:/Users/Jose Manuel/Documents/1_programas/Automatas II/Competencia_3/Ejercicio_9/Expr.g4 by ANTLR 4.13.1
...
public class ExprParser extends Parser {
	...
	public static final int
		IF=1, PARENT_IZQ=2, PARENT_DER=3, IDT=4, MAYOR=5, NUM=6, WS=7;
	public static final int
		RULE_root = 0, RULE_op_aritmetico = 1, RULE_expr = 2;
	private static String[] makeRuleNames() {
		return new String[] {
			"root", "op_aritmetico", "expr"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "IF", "PARENT_IZQ", "PARENT_DER", "IDT", "MAYOR", "NUM", "WS"
		};
	}
	...
	public final Op_aritmeticoContext op_aritmetico() throws RecognitionException {
		...
		enterRule(_localctx, 2, RULE_op_aritmetico);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(9);
