...
def serializedATN():
    return [
        4,1,31,10,2,0,7,0,2,1,7,1,1,0,1,0,1,0,1,1,1,1,1,1,0,0,2,0,2,0,0,
...
class ExprParser ( Parser ):
    ...
    literalNames = [ "<INVALID>", "'CREATE'", "'TABLE'", "'SERIAL'", "'PRIMARY'", 
                     "'KEY'", "'NOT'", "'NULL'", "'VARCHAR'", "'INTEGER'", 
                     "'DATE'", "'INSERT'", "'INTO'", "'VALUES'", "'SELECT'", 
                     "'FROM'", "'WHERE'", "'INNER'", "'JOIN'", "'UPDATE'", 
                     "'SET'", "'ON'", "'='", "','", "'.'", "';'", "'('", 
                     "')'" ]

    symbolicNames = [ "<INVALID>", "CREATE", "TABLE", "SERIAL", "PRIMARY", 
                      "KEY", "NOT", "NULL", "VARCHAR", "INTEGER", "DATE", 
                      "INSERT", "INTO", "VALUES", "SELECT", "FROM", "WHERE", 
                      "INNER", "JOIN", "UPDATE", "SET", "ON", "IGUAL", "COMA", 
                      "PUNTO", "PUNTO_COMA", "PARENT_IZQ", "PARENT_DER", 
                      "CADENA", "IDT", "NUM", "WS" ]
